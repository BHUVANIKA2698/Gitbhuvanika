...
public class TestNGBasics {
	...
	public void verifyPageTitleTest() {
		...
		public void CreateAccountTest() {
			...
			driver.findElement(By.id("address")).sendKeys("7 mcghill, toronto");
			driver.findElement(By.id("city")).sendKeys("ontraio");
			driver.findElement(By.id("id_state")).sendKeys("ontraio");
			driver.findElement(By.id("postcode")).sendKeys("60004");
			driver.findElement(By.id("phone_mobile")).sendKeys("6543217896");
